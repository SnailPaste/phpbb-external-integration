...
/**
 *
 * From Pages extension for the phpBB Forum Software package.
 *
...
namespace snailpaste\phpbbexternalintegration\exception;
...
class base extends \Exception
{
    ...
    public function add_lang(\phpbb\language\language $lang)
    {
        ...
        // Add our language file
        $lang->add_lang('exceptions', 'snailpaste/phpbbexternalintegration');
